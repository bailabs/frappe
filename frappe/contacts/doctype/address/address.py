...
def insert_address():
	...
	for x in f:
		...
		count+=1
		print(count)
def address_query_billing(address_type, link_doctype, link_name):
	return frappe.get_all("Address",filters={'address_type':"Billing"},fields=["name"])